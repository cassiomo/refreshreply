...
import com.xzero.refreshreply.staggered.DynamicHeightPicassoCardThumbnailView;
import com.xzero.refreshreply.staggered.data.Image;
import com.xzero.refreshreply.staggered.data.MockImageLoader;
import com.xzero.refreshreply.staggered.data.Section;
import com.xzero.refreshreply.staggered.data.ServerDatabase;
 ...
 */
public class AdStaggeredGridFragment extends BaseListFragment {

    ServerDatabase mServerDatabase;
    CardGridStaggeredArrayAdapter mCardArrayAdapter;

    public AdStaggeredGridFragment() {
        super();
    }

    public static AdStaggeredGridFragment newInstance() {
        return new AdStaggeredGridFragment();
    }
